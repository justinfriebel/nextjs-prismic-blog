"use strict";exports.__esModule=true;exports.getCssModuleLocalIdent=getCssModuleLocalIdent;var _loaderUtils=_interopRequireDefault(require("loader-utils"));var _path=_interopRequireDefault(require("path"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getCssModuleLocalIdent(context,_,exportName,options){const relativePath=_path.default.relative(context.rootContext,context.resourcePath).replace(/\\+/g,'/');// Generate a more meaningful name (parent folder) when the user names the
// file `index.module.css`.
const fileNameOrFolder=relativePath.endsWith('index.module.css')&&relativePath!=='pages/index.module.css'?'[folder]':'[name]';// Generate a hash to make the class name unique.
