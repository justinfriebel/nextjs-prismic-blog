...
export declare function printTreeView(list: readonly string[], pageInfos: Map<string, PageInfo>, serverless: boolean, { distPath, pagesDir, pageExtensions, buildManifest, isModern, }: {
    distPath: string;
    pagesDir: string;
