                ...
                return {
                    ...
                    fn: async (_req, res, params, _parsedUrl) => {
                        ...
                        if (route.type === 'redirect') {
                            ...
                            res.setHeader('Location', url_1.format(Object.assign(Object.assign({}, parsedDestination), { pathname: parsedNewUrl.pathname, hash: parsedNewUrl.hash, search: undefined })));
                            res.statusCode =
                                route.statusCode || constants_1.DEFAULT_REDIRECT_STATUS;
                            res.end();
                            return {
                                finished: true,
                            };
